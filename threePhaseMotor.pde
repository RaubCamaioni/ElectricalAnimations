...
void twoPoleMotor() {
  ...
  wires.add(new Wire(width/2 + 87, height/2 -  50, 1000,  true, freq,  2/3*PI));     //b
  wires.add(new Wire(width/2 - 87, height/2 +  50, 1000, false, freq,  2/3*PI));     //b'
  wires.add(new Wire(width/2 - 87, height/2 -  50, 1000,  true, freq, -2/3*PI));     //c
  wires.add(new Wire(width/2 + 87, height/2 +  50, 1000, false, freq, -2/3*PI));     //c'
}
